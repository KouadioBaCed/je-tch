 ...
 */
const POSTER_ALT =
  "Les Journées de l'Entreposage Tchologo 2026 — 30 sept au 3 oct 2026, Kong · Ouangolodougou · Ferkessédougou. Entreposage et valorisation des produits agricoles : de la perte post-récolte à la compétitivité numérique.";
